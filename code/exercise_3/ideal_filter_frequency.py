...
lowpass_filtered_amplitude = apply_frequency_filtering(image_amplitude, 'ideal', 'lowpass', 30)
highpass_filtered_amplitude = apply_frequency_filtering(image_amplitude, 'ideal', 'highpass', 30)
...
plot_images(image, filtered_lowpass_image_8bit, title='Ideal low-pass filter applied')
plot_images(image, filtered_highpass_image_8bit, title='Ideal high-pass filter applied')