...
lowpass_filtered_amplitude = apply_frequency_filtering(image_amplitude, 'butterworth', 'lowpass', 30)
highpass_filtered_amplitude = apply_frequency_filtering(image_amplitude, 'butterworth', 'highpass', 30)
...
plot_images(image, filtered_lowpass_image_8bit, title='Butterworth low-pass filter applied')
plot_images(image, filtered_highpass_image_8bit, title='Butterworth high-pass filter applied')