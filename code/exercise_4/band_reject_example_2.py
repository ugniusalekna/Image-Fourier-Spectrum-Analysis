...
from frequency_filtering.noise_filters import apply_band_filter
...
noisy_Kidney1_8bit = read_image('../../data/Kidney1-Crop-Noise2.tif')
...
lower_cutoff, upper_cutoff = 370, 390

filtered_amplitude_Kidney1, filtered_Kidney1 = apply_band_filter(noisy_Kidney1_float, lower_cutoff, upper_cutoff)
